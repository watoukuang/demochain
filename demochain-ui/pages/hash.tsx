  ...
  return (
    <div className="sha256-container px-4 py-8">
      <div className="sha256-contain max-w-4xl mx-auto">
        ...
        <div className="sha256-card rounded-lg border bg-white border-gray-200 dark:border-gray-700 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 shadow-xl">
