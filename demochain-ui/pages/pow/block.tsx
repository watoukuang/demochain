        ...
        <div className="r-card rounded-lg border bg-white border-gray-200 dark:border-gray-700 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 shadow-xl">
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center gap-2">
              ...
              >停止</button>
              <button
                onClick={async () => { try { await navigator.clipboard.writeText(hash); setCopied(true); setTimeout(() => setCopied(false), 1200); } catch {} }}
          ...
          <div className="p-6 space-y-6">
            <div className="flex items-center">
              ...
              <div className="flex-1 flex items-center">
                <span className="inline-flex items-center h-10 px-3 bg-gray-50 border border-r-0 border-gray-300 text-gray-700 text-sm rounded-l dark:bg-black/30 dark:border-white/30 dark:text-white">#</span>
                <input
                  type="number"
                  value={height}
                  min={1}
