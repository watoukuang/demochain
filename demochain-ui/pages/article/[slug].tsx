...
import {Article} from '@/src/shared/types/article';
import {getArticleBySlug, getRelatedArticles} from '@/src/shared/api/articles';
    ...
    useEffect(() => {
        ...
        const loadArticle = async () => {
            try {
                ...
                // 加载相关文章
                const related = await getRelatedArticles(articleData.id, 3);
    ...
    return (
        <>
            <Head>
                ...
                <meta name="article:author" content={article.author.name}/>
                        ...
                        <header className="px-8 pt-8 pb-6 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex flex-wrap items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
                                <div className="flex items-center">
                                    <div
                                        className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold text-sm mr-3">
