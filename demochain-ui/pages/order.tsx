                                ...
                                <table className="w-full">
                                    ...
                                    {orders.map((order, index) => (
                                        <tr key={order.id}
                                            ...
                                            <td className="px-6 py-4">
                                                    <span
                                                        className={`inline-flex px-3 py-1 text-xs font-medium rounded-full ${getStatusColor(order.state || order.status || 'unknown')}`}>
                                                        {getStatusText(order.state || order.status || 'unknown')}
                                                    </span>
                                            </td>
