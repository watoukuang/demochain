            ...
            <div
                ...
                <div className="p-6 border-b border-gray-200 dark:border-[#2a2c31]">
                    ...
                    <div className="relative mb-1">
                        ...
                        />
                        <svg className="absolute left-3 top-2.5 h-4 w-4 text-gray-400 dark:text-gray-500" fill="none"
                        ...
                        +{term.relatedTerms.length - 3}
                                ...
                                <div className="mt-3 pt-3 border-t border-gray-100 dark:border-[#2a2c31]">
                                    <div
                                        ...
                                        <span>点击查看详情</span>
                                        <svg className="ml-1 w-3 h-3 group-hover:translate-x-0.5 transition-transform"
