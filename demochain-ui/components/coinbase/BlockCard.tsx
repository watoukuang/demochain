      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center">
          ...
          <div className="flex-1 flex items-center">
            <span className="px-2 py-1.5 bg-gray-100 border border-r-0 border-gray-300 text-gray-600 text-sm rounded-l dark:bg-black/30 dark:border-white/30 dark:text-white">#</span>
            <input
              type="number"
              value={block.height}
              disabled
